    ...
    <div class="col-md-12">
        <div class="row">
            <div class="col-md-6 offset-md-1">
                <h1><?= $movie->title ?></h1>
                <p class="page-description">Alteração de filmes</p>
                <form id="edit-movie-form" action="<?= $BASE_URL ?>movie_process.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <select type="text" class="form-control" id="category" name="category">
                            ...
                            <option value="Corrida" <?= $movie->category === "Corrida" ? "selected": "" ?>>Corrida</option>
                        <select/>
                    </div>
                    <div class="form-group">
                        <label for="trailer">Trailer:</label>
                        <input type="text" class="form-control" id="trailer" name="trailer" placeholder="Insira o link do trailer (o link deve ser incorporado)" value="<?= $movie->trailer ?>">
                    </div>
                    <div class="form-group">
                        <label for="description">Descrição do filme:</label>
                        <textarea name="description" id="description" rows="5" class="form-control" placeholder="Digite a descrição do filme">
                            <?= $movie->description ?>
                        </textarea>
                    </div>
            ...
            <div class="col-md-3">
                <div class="movie-image-container imagem-filme-edit" style="background-image: url(<?= $BASE_URL ?>imagens/movies/<?= $movie->image ?>)"></div>
            </div>
        </div>
    </div>
</div>
